...
### 2.2 The clean-300k architecture sweep (in progress)
...
an approximation, n=1 — not a converged verdict. A/B/C are being resumed to convergence on
Spot; a converged round-robin + a controlled D-vs-A is the clean follow-up. Catalog row:
