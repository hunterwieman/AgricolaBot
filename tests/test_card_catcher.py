...
def _with_people(state, idx, *, total, home, newborns=0):
    # Faking "k workers already out" is faking k acts of placing, so the stamp
    # carries the coherent placement-act counter (ruling 79 — the ordinal cards
    # read the stored counter, not the people fields).
