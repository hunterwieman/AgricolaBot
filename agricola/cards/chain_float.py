...
for a pasture/stable). So, exactly like Handplow: an optional `round_space_collection` trigger
surfaced as a FireTrigger at the collection window's choice host, with the host's
