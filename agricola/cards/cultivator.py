"""Cultivator (occupation, D104; Consul Dirigens Expansion; players 1+).
...
The mechanism is identical to Barrow Pusher (A105, "…1 clay and 1 food") with
clay → wood.
...
def _apply(state: GameState, idx: int) -> GameState:
    ...
    p = fast_replace(state.players[idx],
                     resources=state.players[idx].resources + Resources(wood=tiles, food=tiles))
