...
- **Status**: **NEW STRONGEST, clear promotion candidate.** Not yet `nn_models/best` (that pointer is still the separate-net `M_82k`; needs value-only consumer wiring). Design: **`SHARED_TRUNK.md`**.
